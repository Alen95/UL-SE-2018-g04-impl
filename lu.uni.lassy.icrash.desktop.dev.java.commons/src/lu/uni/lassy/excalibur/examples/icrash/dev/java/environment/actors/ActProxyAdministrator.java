...
public interface ActProxyAdministrator extends ActProxyAuthenticated {
	...
	/**
	 * A message received from the server side actor saying the survey was created
	 * @return The success of the method
	 * @throws RemoteException Thrown if the server is offline
	 */
	...
	/**
	 * A message received from the server side actor saying the survey was edited
	 * @return The success of the method
	 * @throws RemoteException Thrown if the server is offline
	 */
	...
	/**
	 * A message received from the server side actor saying the question was added
	 * @return The success of the method
	 * @throws RemoteException Thrown if the server is offline
	 */
