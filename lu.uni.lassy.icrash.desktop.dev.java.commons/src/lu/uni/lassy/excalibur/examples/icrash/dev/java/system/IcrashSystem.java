...
public interface IcrashSystem extends Remote {
	...
	/**
	 * Adds a survey with the details specified
	 * @param aDtSurveyID the ID to create the survey with
	...
	/**
	 * Adds a question with the provided data
	...
	/**
	 * Retrieve all the surveys as list of CtSurvey from the database
